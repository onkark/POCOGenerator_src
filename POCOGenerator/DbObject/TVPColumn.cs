...
{
    public class TVPColumn : IDbObject
    {
        ...
        {
            get { return (is_nullable.HasValue && is_nullable.Value); }
        }

        public override string ToString()
        {
            return name + " (" + DataTypeDisplay + PrecisionDisplay + ", " + (IsNullable ? "null" : "not null") + ")";
        }
    }
}
